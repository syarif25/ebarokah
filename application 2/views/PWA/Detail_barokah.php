            ...
            .then(res => {
                ...
                if (J === 'pengajar') {
                    ...
                    <div class="list-compact-native">
                        ...
                        ${rowLine('Kehadiran', fmt(f.kehadiran))}
                ...
                body.innerHTML = `
                    <div class="list-compact-native">
                    ${rowLine('Transport', fmt(f.transport))}
                    ${rowLine('Konsumsi', fmt(f.konsumsi))}
                    </div>
                    <div class="divider my-2"></div>
                    <div class="d-flex justify-content-between align-items-center">
                    <div class="font-700">Total (Rp)</div><div class="font-700">${fmt(f.total)}</div>
                    ...
                    const hadirSub = (typeof d.jhadir_normal === 'number' && d.jhadir_normal > 0)
                        ? `Hadir Normal <strong>${d.jhadir_normal}</strong> Kali` : '';
