...
class Penempatan_satpam_model extends CI_Model {
	var $table = 'satpam';
	var $column_order = array('id_satpam',null);
	var $column_search = array('id_satpam'); 
	var $order = array('id_satpam' => 'desc'); // default order 
	...
	function _get_datatables_query()
	{
        ...
        $this->db->select('*');
		$this->db->from('satpam');
		$this->db->join('transport', 'satpam.id_transport = transport.id_transport');
        $this->db->join('umana', 'satpam.nik = umana.nik'); 
	...
	{
		$this->db->update('satpam', $data, $where);
	...
	public function get_by_id($id)
	{
		...
		$this->db->join('transport', 'satpam.id_transport = transport.id_transport');
		$this->db->join('umana', 'satpam.nik = umana.nik'); 
		$this->db->where('satpam.id_satpam',$id);
		$query = $this->db->get();
