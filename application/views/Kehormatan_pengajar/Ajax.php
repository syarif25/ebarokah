<script src="<?php echo base_url() ?>assets/vendor/global/global.min.js"></script>
    ...
    table =   $('#tabel_view').DataTable({
        "ajax": {
            "url": "<?php echo site_url('Kehormatan_pengajar/data_list')?>",
            "type": "POST"
        },
    ...
    function save()
    {
        ...
        var url;
        if(save_method == 'add') {
            url = "<?php echo site_url('kehormatan_pengajar/ajax_add')?>";
            var pesan = ' Menambah data';
        } else {
            url = "<?php echo site_url('kehormatan_pengajar/ajax_update')?>";
            var pesan = ' Edit data';
        }
    ...
    function edit_user(id)
    {
        ...
        $.ajax({
            url : "<?php echo site_url('kehormatan_pengajar/ajax_edit')?>/" + id,
            type: "GET",
            dataType: "JSON",
            success: function(data)
            {
                $('[name="id_barokah_kehormatan_pengajar"]').val(data.id_barokah_kehormatan_pengajar);
                            ...
                            <div class="basic-form">
                                <div class="row">
                                    ...
                                    <label>Min Masa Pengabdian</label>
                                        <div class="input-group mb-3 input-success-o">
                                            <input type="number" name="min_masa_pengabdian" class="form-control">
                                            <span class="help-block text-danger" style="color:red"></span>
                                        </div>
                                    </div>
                                    <div class="col-4">
                                    <label>Min Masa Pengabdian</label>
                                        <input type="hidden" name="id_barokah_kehormatan_pengajar" class="">
                                        <div class="input-group mb-3 input-success-o">
                                            <input type="number" name="max_masa_pengabdian" class="form-control">
                                            <span class="help-block text-danger" style="color:red"></span>
                                        </div>
                                    </div>
                                </div>
