<div class="container-fluid">
    ...
    <div class="row page-titles">
        <div class="col-md-5 align-self-center">
            <h3 class="text-themecolor"><i class="fas fa-shield-alt"></i> Dashboard Barokah Satpam</h3>
        </div>
        <div class="col-md-7 align-self-center text-end">
            <div class="d-flex justify-content-end align-items-center">
                <ol class="breadcrumb justify-content-end">
                    <li class="breadcrumb-item"><a href="javascript:void(0)">Dashboard</a></li>
                    <li class="breadcrumb-item active">Barokah Satpam</li>
                </ol>
            </div>
        </div>
    </div>
            ...
            <div class="card card-summary">
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="ms-3">
                            <h6 class="text-muted mb-1">Jumlah Satpam Aktif</h6>
                            <h4 class="mb-0" id="cardJumlahSatpam">0 Satpam</h4>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card card-summary">
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="ms-3">
                            <h6 class="text-muted mb-1">Satpam Putra</h6>
                            <h4 class="mb-0" id="cardSatpamPutra">0 Satpam</h4>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card card-summary">
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="ms-3">
                            <h6 class="text-muted mb-1">Satpam Putri</h6>
                            <h4 class="mb-0" id="cardSatpamPutri">0 Satpam</h4>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-lg-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <canvas id="chartKomponen" height="300"></canvas>
                </div>
            </div>
        </div>
        <div class="col-lg-6">
            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        <h4 class="card-title"><i class="fas fa-table"></i> Detail Data Barokah Satpam</h4>
