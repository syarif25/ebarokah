                                ...
                                <div class="text-center">
                                    ...
                                    <h5 class="text-primary d-inline">- </h5>
                                        <div class="col">
                                            ...
                                            if ($umana->jk == 'Laki-laki'){
                                            ?>
                                        <img src="<?php echo base_url(); ?>assets/cowok.png" alt="" class="img-fluid rounded " style="height: 120px;">
                                        <?php } else { ?>
                                        <img src="<?php echo base_url(); ?>assets/putri.jpg" alt="" class="img-fluid rounded " style="height: 120px;">
                                        <?php }?>
                                        </div>
                                    </div>
                    ...
                    <div class="profile-blog">
                        ...
                        <div class="row">
                            <div class="row mb-2">
                                ...
                                <div class="col-sm-9 col-7"><span>: <?php echo $umana->nik; ?></span>
                                </div>
                            </div>
                            <div class="row mb-2">
                                <div class="col-sm-3 col-5">
                                    <h5 class="f-w-500">NIY<span class="pull-end"></span>
                                    </h5>
                                </div>
                            ...
                            <!--        </h5>-->
                            <!--    </div>-->
                            <!--    <div class="col-sm-9 col-7"><span>: <?php echo $umana->nama_lengkap; ?></span>-->
                            <!--    </div>-->
                            <!--</div>-->
                            <!-- <div class="row mb-2">
                                <div class="col-sm-3 col-5">
                                    <h5 class="f-w-500">Gelar Depan <span class="pull-end"></span>
                                    </h5>
                                </div>
                                <div class="col-sm-9 col-7"><span>: <?php echo $umana->gelar_depan; ?></span>
                                </div>
                            </div>
                            <div class="row mb-2">
                                <div class="col-sm-3 col-5">
                                ...
                                <div class="col-sm-9 col-7"><span>: <?php echo $umana->gelar_belakang; ?></span>
                                </div>
                            </div> -->
                            <div class="row mb-2">
                                <div class="col-sm-3 col-5">
                                ...
                                <div class="col-sm-9 col-7"><span>: <?php echo $umana->alamat_domisili; ?></span>
                                </div>
                            </div>
                            <div class="row mb-2">
                                <div class="col-sm-3 col-5">
                                    <h5 class="f-w-500">TMT Struktural<span class="pull-end"></span>
                                    </h5>
                                </div>
                                <div class="col-sm-9 col-7"><span>: <?php if($umana->tmt_struktural == '0000-00-00')
                                    { echo "-"; }else {
                                $tmt_struktur = date("Y", strtotime($umana->tmt_struktural)); echo $tmt_struktur;
                                } ?></span>
                                </div>
                            </div>
                            <div class="row mb-2">
                                <div class="col-sm-3 col-5">
                                    <h5 class="f-w-500">TMT Guru<span class="pull-end"></span>
                                    </h5>
                                </div>
                                <div class="col-sm-9 col-7"><span>: <?php if($umana->tmt_guru == '0000-00-00')
                                    { echo "-"; }else {
                                $tmt_guru = date("Y", strtotime($umana->tmt_guru)); echo $tmt_guru; } ?></span>
                                </div>
                            </div>
                            <div class="row mb-2">
                                <div class="col-sm-3 col-5">
                                    <h5 class="f-w-500">TMT Dosen<span class="pull-end"></span>
                                    </h5>
                                </div>
                                <div class="col-sm-9 col-7"><span>: <?php if($umana->tmt_dosen == '0000-00-00')
                                    { echo "-"; }else {
                                $tmt_dosen = date("Y", strtotime($umana->tmt_dosen)); echo $tmt_dosen; }?></span>
                                </div>
                            </div>
                            <div class="row mb-2">
                                <div class="col-sm-3 col-5">
                                    <h5 class="f-w-500">NIDN/NUPTK<span class="pull-end"></span>
                                    </h5>
                                </div>
                                <div class="col-sm-9 col-7"><span>: <?php echo $umana->nidn; ?></span>
                                </div>
                            </div>
                            <!--<div class="row mb-2">-->
                            <!--    <div class="col-sm-3 col-5">-->
                            <!--        <h5 class="f-w-500">Jabatan Akademik<span class="pull-end"></span>-->
                            <!--        </h5>-->
                            <!--    </div>-->
                            ...
                            <div class="row mb-2">
                                ...
                                <div class="col-sm-9 col-7"><span>: <?php echo $umana->status_nikah; ?></span>
                                </div>
                            </div>
                            <div class="row mb-2">
                                <div class="col-sm-3 col-5">
                                    <h5 class="f-w-500">Nomor Handphone<span class="pull-end"></span>
                                    </h5>
                                </div>
                                <div class="col-sm-9 col-7"><span>: <?php echo $umana->nomor_hp; ?></span>
                                </div>
                            </div>
                            <!--<div class="row mb-2">-->
                            <!--    <div class="col-sm-3 col-5">-->
                            <!--        <h5 class="f-w-500">Pendidikan Terakhir<span class="pull-end"></span>-->
                            <!--        </h5>-->
                            <!--    </div>-->
                            <!--    <div class="col-sm-9 col-7"><span>: <?php echo $umana->ijazah_terakhir; ?></span>-->
                            <!--    </div>-->
                            <!--</div>-->
                            <div class="row mb-2">
                                <div class="col-sm-3 col-5">
                                    <h5 class="f-w-500">Nomor Rekening<span class="pull-end"></span>
                                    </h5>
                                </div>
                                <div class="col-sm-9 col-7"><span>: <?php echo $umana->no_rekening; ?></span>
                                </div>
                            </div>
                            <div class="row mb-2">
                                <div class="col-sm-3 col-5">
                                    <h5 class="f-w-500">Nama Bank<span class="pull-end"></span>
                                    </h5>
                                </div>
