<div class="container-fluid">
	<div class="row page-titles">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="javascript:void(0)">Per Lembaga</a></li>
        </ol>
    </div>
    <!-- row -->
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <div>
                        <h4 class="card-title mb-0">Laporan Barokah Per Lembaga</h4>
                        <p class="text-muted mb-0 mt-1"><i class="fas fa-info-circle"></i> Menampilkan daftar barokah yang telah dibayarkan per lembaga</p>
                    </div>
                    <div>
                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table id="tabel_laporan_lembaga" class="table table-hover table-striped display" style="min-width: 845px">
                            <thead>
                                <tr>
