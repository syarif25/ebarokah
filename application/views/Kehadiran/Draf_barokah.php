...
<div class="container-fluid">
    <div class="row page-titles">
        <ol class="breadcrumb">
            <li class="breadcrumb-item active"><a href="javascript:void(0)">DRAF BAROKAH</a></li> 
    ...
    <div class="row">
       <div class="col-lg-12">
            <div class="card">
                ...
                <a href="<?php echo base_url() ?>Kehadiran/Cetak/<?php echo $periode->id_kehadiran_lembaga; ?>" class="btn btn-warning text-dark" target="_blank"><i class="fas fa-print"></i> Cetak</a>  
                </div>
                <form action="#" id="form">
                    <div class="card-body">
                                ...
                                <tbody>
                                   ...
                                   $no = 1;
                                    ...
                                    foreach($isilist as $key){
                                            ...
                                            //             $masa_p = $mp;
                                            //         }
                                            // } else if ($key->id_bidang == "Bidang DIKTI") {
                                    ...
                                    <tr>
                                        <td>
                                         ...
                                         <td>
                                         <a class="text-success" href="#"><?php echo htmlentities($key->gelar_depan.' '.$key->nama_lengkap.' '.$key->gelar_belakang); ?></a>    
                                        ...
                                        <td>
                                            <?php echo htmlentities(rupiah($tbk)); ?>
