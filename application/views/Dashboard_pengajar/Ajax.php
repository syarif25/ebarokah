...
$(document).ready(function() {
    ...
    $('#btnExport').click(function() {
        ...
        window.location.href = '<?php echo base_url() ?>Dashboard_pengajar/export_excel?bulan=' + bulan + '&tahun=' + tahun + '&lembaga=' + lembaga;
    });
    ...
    function loadSummaryData() {
        ...
        $.ajax({
            url: '<?php echo base_url() ?>Dashboard_pengajar/get_summary',
            type: 'POST',
            data: {
            ...
            success: function(data) {
                ...
                $('#cardJumlahPengajar').text(data.jumlah_pengajar + ' Pengajar');
                $('#cardPengajarPutra').text(data.pengajar_putra + ' Pengajar');
                $('#cardPengajarPutri').text(data.pengajar_putri + ' Pengajar');
    ...
    function loadPieChart() {
        ...
        $.ajax({
            url: '<?php echo base_url() ?>Dashboard_pengajar/get_chart_data',
            type: 'POST',
            data: {
                type: 'pie',
                bulan: $('#filterBulan').val(),
    ...
    function loadDonutChart() {
        $.ajax({
            ...
            success: function(data) {
                ...
                const values = [
                    parseFloat(data.total_mengajar || 0),
                    parseFloat(data.total_dty || 0),
                    ...
                    parseFloat(data.total_walkes || 0)
                ];
    ...
    function initDataTable() {
        table = $('#tableDetail').DataTable({
            ...
            serverSide: true,
            ajax: {
                url: '<?php echo base_url() ?>Dashboard_pengajar/get_table_data',
                type: 'POST',
                data: function(d) {
    ...
    function loadDetail(id) {
        $.ajax({
            url: '<?php echo base_url() ?>Dashboard_pengajar/get_detail/' + id,
            type: 'GET',
            dataType: 'json',
            success: function(data) {
