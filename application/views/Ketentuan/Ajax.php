<script src="<?php echo base_url() ?>assets/vendor/global/global.min.js"></script>
   ...
   <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/toastify-js/src/toastify.min.css" />
    ...
    table =   $('#tabel_view').DataTable({
        "ajax": {
            "url": "<?php echo site_url('Ketentuan_barokah/data_list')?>",
            "type": "POST"
        },
    ...
    function save()
    {
        ...
        var url;
        if(save_method == 'add') {
            url = "<?php echo site_url('Ketentuan_barokah/ajax_add')?>";
            var pesan = ' Menambah data';
        } else {
            url = "<?php echo site_url('Ketentuan_barokah/ajax_update')?>";
            var pesan = ' Edit data';
        }
    ...
    function edit_user(id)
    {
        ...
        $.ajax({
            ...
            $('[name="wajib_hadir"]').val(data.wajib_hadir);
                    ...
                    <form action="#" id="form">
                        ...
                        <div class="card-body">
                            <div class="basic-form">
                                ...
                                <input type="hidden" name="id_ketentuan" class="">
                                ...
                                <div class="input-group mb-3 input-success-o">
                                    <select name="kategori" class="form-control">
                                        <option value=""></option>
                                        <option >Pengurus Pesantren</option>
                                        <option >DIKJAR</option>
                                        <option >DIKTI</option>
                                        <option>UNIB</option>
                                        <option >Kelas Kota</option>
                                        <option >Pengurus Yayasan/Perangkat Khusus</option>
                                    </select>
                                    <span class="help-block text-danger" style="color:red"></span>
                                </div>
                                <label>Barokah</label>
                                <div class="input-group mb-3 input-success-o">
                                    <input type="text" name="barokah" class="form-control" id="inputku">
                                    <span class="help-block text-danger" style="color:red"></span>
                                </div>
                                <label>Wajib Hadir (Hari/Minggu)</label>
                                <div class="input-group mb-3 input-success-o">
                                    <input type="number" name="wajib_hadir" class="form-control" min="0" max="7">
                                    <span class="help-block text-danger" style="color:red"></span>
                                </div>
