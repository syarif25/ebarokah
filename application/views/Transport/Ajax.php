<script src="<?php echo base_url() ?>assets/vendor/global/global.min.js"></script>
    ...
    table =   $('#tabel_view').DataTable({
        "ajax": {
            "url": "<?php echo site_url('transport/data_list')?>",
            "type": "POST"
        },
    ...
    function edit_transport(id)
    {
        ...
        $.ajax({
            ...
            $('[name="alamat"]').val(data.nama_transport);
            $('[name="kategori"]').val(data.kategori_transport);
            $('[name="nominal"]').val(data.nominal_transport);
            $('#modal_transport').modal('show'); // show bootstrap modal when complete loaded
            },
            error: function (jqXHR, textStatus, errorThrown)
            {
...
<div id="modal_transport" class="modal fade bd-example-modal-lg" tabindex="-1" aria-hidden="true" style="display: none;">
                ...
                <div class="card">
                    <form action="#" id="form">
                        <div class="card-header">
                            <h4 class="card-title">Form Transport</h4>
                        </div>
                        <div class="card-body">
                            <div class="basic-form">
                                <label>Alamat </label>
                                <input type="hidden" name="id_transport" class="">
