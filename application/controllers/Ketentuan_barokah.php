...
class Ketentuan_barokah extends CI_Controller {
	...
	public function data_list()
	{
		...
		foreach ($list as $datanya) {
            ...
            $row[] = $datanya->wajib_hadir . ' hari/minggu';
			//add html for action
    ...
    public function ajax_add()
	{
		...
		$data = array(
            ...
            'wajib_hadir' 	=> $this->input->post('wajib_hadir'),
        );
	...
	private function _validate()
    {
        ...
        if ($this->input->post('wajib_hadir') == '') {
            $data['inputerror'][] = 'wajib_hadir';
            $data['error_string'][] = 'Wajib hadir harus diisi';
            $data['status'] = FALSE;
        }
