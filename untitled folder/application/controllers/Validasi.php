		...
		foreach ($list as $datanya) {
		    ...
		    if ($datanya->status == 'acc'){
				...
				if ($datanya->kategori == 'Struktural'){
					$row[] = '<a href="validasi/koreksi/'.$encrypted_id.'"  class="btn btn-info  me-1 px-3"><i class="fa fa-clipboard m-0"></i> Jml Kehadiran</a>
						 <a href="validasi/koreksi_fullscreen/'.$encrypted_id.'"  class="btn btn-danger  me-1 px-3"><i class="fa fa-clipboard m-0"></i> cek new</a>';
