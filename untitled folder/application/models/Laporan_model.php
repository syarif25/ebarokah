...
//             ORDER BY id_total_barokah DESC;");
	...
	{
// 	    $query_lama = $this->db->query("select id_total_barokah_pengajar, pengajar.kategori, gelar_depan, gelar_belakang, jumlah_total, nama_lembaga, total_barokah_pengajar.bulan, total_barokah_pengajar.tahun, nama_lengkap, diterima, tmt_dosen, tmt_guru, total_barokah_pengajar.jumlah_hadir, nominal_kehadiran, mp, tunkel, total_barokah_pengajar.tun_anak, total_barokah_pengajar.kehormatan, total_barokah_pengajar.walkes, total_barokah_pengajar.nominal_kehadiran, umana.nik 
// 		from kehadiran, kehadiran_lembaga, pengajar, umana, total_barokah_pengajar, lembaga, kehadiran_pengajar
// 		WHERE lembaga.id_lembaga = pengajar.id_lembaga and kehadiran_lembaga.id_kehadiran_lembaga = kehadiran_pengajar.id_kehadiran_lembaga and pengajar.id_pengajar = kehadiran_pengajar.id_pengajar and pengajar.nik = umana.nik and total_barokah_pengajar.id_pengajar = kehadiran_pengajar.id_pengajar 
// 		and umana.nik = $id and kehadiran_lembaga.status = 'selesai' and YEAR(timestamp) = YEAR(CURRENT_DATE) AND MONTH(timestamp) = MONTH(CURRENT_DATE) GROUP by total_barokah_pengajar.id_total_barokah_pengajar ORDER BY id_total_barokah_pengajar DESC");
		
		$query = $this->db->query("SELECT u.nik, u.nama_lengkap, l.nama_lembaga, tbp.*, p.id_pengajar FROM total_barokah_pengajar tbp
