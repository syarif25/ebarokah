            ...
            <div class="dlabnav-scroll">
				<ul class="metismenu" id="menu">
					...
					<li><a class="has-arrow" href="javascript:void()">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="<?php echo base_url() ?>kehadiran">Struktural</a></li>
					...
					<li><a class="has-arrow" href="javascript:void()">
                        ...
                        <ul aria-expanded="false">
                            <!--<li><a href="<?php echo base_url() ?>Laporan/per_bulan">Per Bulan</a></li>-->
                            <li><a href="<?php echo base_url() ?>Laporan">Per Lembaga</a></li>
